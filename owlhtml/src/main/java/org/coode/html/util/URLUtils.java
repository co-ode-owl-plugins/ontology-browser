...
//    }
    ...
    public static String createRelativeURL(URL current, URL target) {
        ...
        List<String> currentPath = new ArrayList<>(Arrays.asList(current.getPath().split("/")));
        List<String> targetPath = new ArrayList<>(Arrays.asList(target.getPath().split("/")));
...
//        }
    ...
    public static Map<OWLHTMLParam, String> getParams(URL url) {
        Map<OWLHTMLParam, String> paramMap = new HashMap<>();
