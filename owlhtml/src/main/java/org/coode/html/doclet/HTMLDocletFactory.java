...
public class HTMLDocletFactory {
    ...
    public <O> HTMLDoclet<O> getDoclet(String id){
        try {
            ...
            return (HTMLDoclet<O>) constructor.newInstance(kit);
        }
    ...
    public void load(BufferedReader reader) throws IOException {
        ...
        while((line = reader.readLine()) != null){
            ...
            if (line.length() == 0 || line.startsWith("//")){
                ...
                if (args.length == 2){
                    try {
                        register(args[0].trim(), (Class<? extends HTMLDoclet<?>>) Class.forName(args[1].trim()));
                    }
